...
import com.ai.servicebusiness.mapper.ClientRejectMapper;
import com.ai.servicebusiness.mapper.SysConfNewbieMapper;
import com.ai.servicebusiness.mapper.UserMapper;
...
public class UserUtilX {
    ...
    public Long getUserId() throws Exception {
        ...
        if(null != obj && !"".equals(obj.toString())){
            userId = Long.valueOf((String) obj);
        }
    ...
    public boolean isNewbieStatusOK(Long userId) throws Exception{
        ...
        UserPO userPO = getCacheUserPO(userId);
        if(null == userPO){
            return false;
        }
        return StatusEnum.YES.getCode().equals(userPO.getNewbieStatus());
    }
