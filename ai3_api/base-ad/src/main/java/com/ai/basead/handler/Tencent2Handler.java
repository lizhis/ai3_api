...
public class Tencent2Handler {
    ...
    public void listen(AdTencentParam param) throws Exception{
        //LogUtil.log("腾讯广告2 收到监听事件：" + param.toString());
        String id = null;
        ...
        String key = RedisKey.ad_tencent2_id_ + id;
        redisUtilX.setObj(key,dto,3600*48);

        String activeKey = RedisKey.ad_tencent2_active_id_ + id;
