...
public class Tencent4Handler {
    ...
    public void listen(AdTencentParam param) throws Exception{
        //LogUtil.log("腾讯广告4 收到监听事件：" + param.toString());
        String id = null;
