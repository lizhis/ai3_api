...
public class Tencent3Handler {
    ...
    public void listen(AdTencentParam param) throws Exception{
        //LogUtil.log("腾讯广告3 收到监听事件：" + param.toString());
        String id = null;
